...
local function update_display()
  ...
  state.servers = lsp.get_runtime_lsp_server_names()
  state.enabled_servers = lsp.get_enabled_servers()
...
local function enable_server()
  ...
  local success, err = lsp.enable_servers({ server })
  if success then
...
local function disable_server()
  ...
  local success, err = lsp.disable_servers({ server })
  if success then
